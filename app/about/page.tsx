...
const featuredLocations = [
  {
    ...
    description:
      "A peaceful village surrounded by rice fields, waterfalls, and quiet roads perfect for scenic drives",
  ...
  },
  {
    ...
    description:
      "Located in the northeastern highlands of Bali on the edge of the Mount Batur, this area is known for scenic cafés that overlook the volcano.",
    location: "Kintamani",
  },
  {
    ...
    title: "Sideman",
    description:
      "A peaceful alternative to Ubud, with rice terraces, viewpoint cafés, and a natural infinity pool at Gembleng Waterfall.",
  ...
  },
  {
    ...
    description:
      "A white sand beach in Uluwatu, with high waves, a steady surf crowd, and wide open views of the ocean.",
    location: "Uluwatu",
  },
];
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-24">
          ...
          <div className="md:w-2/3">
            ...
            <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
              <p>
                After spending over 6 months in Bali, I found myself getting
                frustrated with AI travel tools. They kept recommending the same
                touristy, overcrowded spots, which didn’t reflect the Bali I’d
                come to know.
              </p>
              <p>
                I wanted something more thoughtful. Not just generic lists from
                a bot, but real suggestions based on places I had actually
                visited and loved.
              </p>
              <p>
                I knew there were better options, so I built BaliGuide to share
                them. It’s a way to help others experience the side of Bali that
                made me fall in love with it — vibrant, authentic, and full of
                hidden gems.
              </p>
              <p className="text-gray-200 font-medium">
                Thanks for being here. I hope BaliGuide helps you discover the
                same kind of magic I found on the island.
              </p>
            </div>

            <div className="flex gap-4 mt-8">
              <a
                href="https://instagram.com/hannah.chapman0"
        ...
        <section className="mb-24">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              A handpicked collection of places I loved during my time living in
              Bali.
            </p>
          </div>
